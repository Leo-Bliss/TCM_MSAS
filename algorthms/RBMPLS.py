...
if __name__ == '__main__':
    ...
    #
    # """
    # rbm_pls_model = RMB_PLS(2, n01=8, n02=5, alpha=0.05, bs=100, ite=100, vb=0, rs=None)
    # y0_tr_predict, y0_tr_RMSE = rbm_pls_model.train(train_x, test_x, train_y, test_y)
    # print(y0_tr_RMSE)
    #
    # # 预测 test_x
    ...
    # y0_tr_predict, y0_tr_RR, y0_tr_RMSE = rbm_pls_model.PLS_train(train_x, train_y)
    # print(y0_tr_RMSE)
    # y0_tr_predict, y0_tr_RR, y0_tr_RMSE = rbm_pls_model.PLS_predict(train_x, train_y)
    # print(y0_tr_RMSE)
    # y0_te_predict, y0_te_RR, y0_te_RMSE = rbm_pls_model.PLS_predict(test_x, test_y)
    # print(y0_te_RMSE)

    # print("y0_tr_predict", y0_tr_predict)
    # print(y0_tr_RMSE)
    # print("==============================")
    # print("y0_te_predict", y0_te_predict)
    # print(y0_te_RMSE)
    ...
    #        [1, 0, 1, 0],
    #        [1, 1, 1, 1]]
    # n01 = One_RBM(n01=5, alpha=0.05, bs=100, ite=100, vb=0, rs=None)
    # n02 = Two_RBM(n01=5, n02=5, alpha=0.05, bs=100, ite=100, vb=0, rs=None)
    # ah1 = n01.train(np.array(pat))
    # ah01 = n01.tranform(np.array(pat))
    # print(ah1)
    # print(ah01)
    # ah2 = n02.train(np.array(pat))
    # ah02 = n02.tranform(np.array(pat))
    # print(ah2)
    # print(ah02)
